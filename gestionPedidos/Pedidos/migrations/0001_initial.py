    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('componentes', models.ManyToManyField(to='Pedidos.componente')),
            ],
        ),
        migrations.CreateModel(
            name='ProductoPedido',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('componente_solicitado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Pedidos.componente')),
                ('producto_solicitado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Pedidos.producto')),
            ],
        ),
        migrations.AddField(
